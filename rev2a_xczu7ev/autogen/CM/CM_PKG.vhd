...
package CM_CTRL is
  ...
  type CM_CM_C2C_STATUS_MON_t is record
    ...
    PB_RESET                   :std_logic;                      -- Reset of the C2C PHY
  ...
  type CM_CM_C2C_COUNTERS_MON_t is record
    ...
    SOFT_ERROR_RATE            :std_logic_vector(31 downto 0);  -- single bit error rate
    HARD_ERROR_RATE            :std_logic_vector(31 downto 0);  -- multi bit error rate
  ...
  type CM_CM_C2C_CTRL_t is record
    ...
    PHY_MAX_SOFT_ERROR_RATE    :std_logic_vector(31 downto 0);  -- Max soft error rate
    PHY_MAX_HARD_ERROR_RATE    :std_logic_vector(31 downto 0);  -- Max hard error rate
  ...
  constant DEFAULT_CM_CM_C2C_CTRL_t : CM_CM_C2C_CTRL_t := (
                                                           ...
                                                           PHY_MAX_SOFT_ERROR_RATE => x"000000ff",
                                                           PHY_MAX_HARD_ERROR_RATE => x"000000ff"
                                                          );
  ...
  type CM_CM_MONITOR_HISTORY_MON_t is record
    VALID                      :std_logic_vector( 4 downto 0);  -- bytes valid in debug history
    HISTORY_0                  :std_logic_vector( 7 downto 0);  -- byte 0 of uart history
    HISTORY_1                  :std_logic_vector( 7 downto 0);  -- byte 1 of uart history
    HISTORY_2                  :std_logic_vector( 7 downto 0);  -- byte 2 of uart history
    HISTORY_3                  :std_logic_vector( 7 downto 0);  -- byte 3 of uart history
    HISTORY_4                  :std_logic_vector( 7 downto 0);  -- byte 4 of uart history
  end record CM_CM_MONITOR_HISTORY_MON_t;


  type CM_CM_MONITOR_BAD_TRANS_MON_t is record
    ADDR                       :std_logic_vector( 9 downto 0);  -- Sensor addr bits
    DATA                       :std_logic_vector(15 downto 0);  -- Sensor data bits
    ERROR_MASK                 :std_logic_vector( 7 downto 0);  -- Sensor error bits
    RESERVED                   :std_logic_vector( 3 downto 0);  -- Sensor reserved bits
  ...
  type CM_CM_MONITOR_ERRORS_MON_t is record
    ...
    CNT_SOF_V1                 :std_logic_vector(15 downto 0);  -- Monitoring errors. Count of invalid byte types in parsing.
    CNT_SOF_V2                 :std_logic_vector(15 downto 0);  -- Monitoring errors. Count of invalid byte types in parsing.
    ...
    CNT_BYTE5_NOT_DATA         :std_logic_vector(15 downto 0);  -- Monitoring errors. Count of invalid byte types in parsing.
    ...
    CNT_V1                     :std_logic_vector(15 downto 0);  -- Monitoring errors. Count of invalid byte types in parsing.
    CNT_V2                     :std_logic_vector(15 downto 0);  -- Monitoring errors. Count of invalid byte types in parsing.
  ...
  type CM_CM_MONITOR_MON_t is record
    ...
    HISTORY                    :CM_CM_MONITOR_HISTORY_MON_t;
  ...
  type CM_CM_PB_MEM_MOSI_t is record
    clk       : std_logic;
    reset     : std_logic;
    enable    : std_logic;
    wr_enable : std_logic;
  ...
  end record CM_CM_PB_MEM_MOSI_t;
  type CM_CM_PB_MEM_MISO_t is record
    rd_data         : std_logic_vector(18-1 downto 0);
    rd_data_valid   : std_logic;
  end record CM_CM_PB_MEM_MISO_t;
  constant Default_CM_CM_PB_MEM_MOSI_t : CM_CM_PB_MEM_MOSI_t := ( 
                                                     clk       => '0',
                                                     reset     => '0',
                                                     enable    => '0',
                                                     wr_enable => '0',
  ...
  type CM_CM_PB_MON_t is record
    MEM                        :CM_CM_PB_MEM_MISO_t;
  end record CM_CM_PB_MON_t;


  type CM_CM_PB_CTRL_t is record
    RESET                      :std_logic;   
    IRQ_COUNT                  :std_logic_vector(31 downto 0);
    MEM                        :CM_CM_PB_MEM_MOSI_t;          
  end record CM_CM_PB_CTRL_t;


  constant DEFAULT_CM_CM_PB_CTRL_t : CM_CM_PB_CTRL_t := (
                                                         RESET => '0',
                                                         IRQ_COUNT => x"004c4b40",
                                                         MEM => Default_CM_CM_PB_MEM_MOSI_t
                                                        );
  ...
  constant DEFAULT_CM_CM_CTRL_t : CM_CM_CTRL_t := (
                                                   ...
                                                   PB => DEFAULT_CM_CM_PB_CTRL_t
                                                  );
  type CM_MON_t is record
    CM                         :CM_CM_MON_t_ARRAY;
    C2C_REFCLK_FREQ            :std_logic_vector(31 downto 0);
  end record CM_MON_t;
