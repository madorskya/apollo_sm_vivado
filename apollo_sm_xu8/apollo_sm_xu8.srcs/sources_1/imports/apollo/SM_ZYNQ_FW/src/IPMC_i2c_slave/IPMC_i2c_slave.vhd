...
--      )              
  ...
  --registers
  hb_proc: process (clk_axi,reset) is
  begin  -- process hb_proc
    if reset = '1' then
      heart_beat <= '0';
    elsif clk_axi'event and clk_axi = '1' then  -- rising clock edge 
      heart_beat <= '0';
      if ( localAddress(10 downto 0) = "111"&x"FF" and
           (localRdReq = '1' or localWrEn = '1')) then
        heart_beat <= '1';
      end if;
...
--  IPMC_i2c_DEBUG_0 : entity work.IPMC_i2c_DEBUG
--    port map (
--      clk => clk_axi,
--      probe0 => localRdData,
--      probe1 => localWrData,
...
--      probe4(0) => localRdAck,
--      probe5 => localAddress,
--      probe6 => localAddress(10 downto 0),
--      probe7(0) => heart_beat,
--      probe8(0) => PS_is_shutdown,
--      probe9(0) => reset
--      );
