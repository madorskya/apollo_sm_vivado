...
zynq_bd_i: component zynq_bd
     port map (
      ...
      PL_MEM_CM_RAM_PORTB_addr(31 downto 0) => PL_MEM_CM_RAM_PORTB_addr(31 downto 0),
      PL_MEM_CM_RAM_PORTB_clk => PL_MEM_CM_RAM_PORTB_clk,
      PL_MEM_CM_RAM_PORTB_din(31 downto 0) => PL_MEM_CM_RAM_PORTB_din(31 downto 0),
      PL_MEM_CM_RAM_PORTB_dout(31 downto 0) => PL_MEM_CM_RAM_PORTB_dout(31 downto 0),
      PL_MEM_CM_RAM_PORTB_en => PL_MEM_CM_RAM_PORTB_en,
      PL_MEM_CM_RAM_PORTB_rst => PL_MEM_CM_RAM_PORTB_rst,
      PL_MEM_CM_RAM_PORTB_we(3 downto 0) => PL_MEM_CM_RAM_PORTB_we(3 downto 0),
      PL_MEM_RAM_PORTB_addr(31 downto 0) => PL_MEM_RAM_PORTB_addr(31 downto 0),
      PL_MEM_RAM_PORTB_clk => PL_MEM_RAM_PORTB_clk,
      PL_MEM_RAM_PORTB_din(31 downto 0) => PL_MEM_RAM_PORTB_din(31 downto 0),
      PL_MEM_RAM_PORTB_dout(31 downto 0) => PL_MEM_RAM_PORTB_dout(31 downto 0),
      PL_MEM_RAM_PORTB_en => PL_MEM_RAM_PORTB_en,
      PL_MEM_RAM_PORTB_rst => PL_MEM_RAM_PORTB_rst,
      PL_MEM_RAM_PORTB_we(3 downto 0) => PL_MEM_RAM_PORTB_we(3 downto 0),
      ...
      SYS_RESET_bus_rst_n(0) => SYS_RESET_bus_rst_n(0),
      SYS_RESET_intcn_rst_n(0) => SYS_RESET_intcn_rst_n(0),
      ...
      sys_resetter_primary_bus_rst_n(0) => sys_resetter_primary_bus_rst_n(0),
      sys_resetter_primary_intcn_rst_n(0) => sys_resetter_primary_intcn_rst_n(0),
      sys_resetter_primary_rst_n(0) => sys_resetter_primary_rst_n(0)
    );
end STRUCTURE;
